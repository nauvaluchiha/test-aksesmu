...
<html lang="{{ str_replace("_", "-", app()->getLocale()) }}">
    ...
    <body>
        <header class="sticky top-0 bg-white px-3 z-10">
            ...
            >
                <h1
                    class="w-fit cursor-default bg-gradient-to-br from-[#19B561] via-[#55c456] to-[#ACDB41] bg-clip-text text-4xl font-semibold text-transparent ring-1 select-none dark:ring-1"
                >
                    Aksesmu
                </h1>
                <h1 class="hidden sm:block">
                    <a
                        href="https://naufalnasrullah.me"
                        target="_blank"
                        class="text-xl text-blue-500 hover:underline hover:opacity-85"
                    >
                        Naufal Nasrullah
                    </a>
        ...
        <main
            class="flex min-h-screen flex-col-reverse justify-between bg-gradient-to-br from-[#19B561] via-[#55c456] to-[#ACDB41] px-6 sm:px-16 md:flex-row md:px-8 lg:px-16 2xl:px-20"
        >
            <div class="w-full py-10 md:max-w-[60%] xl:max-w-[65%]">
                <div id="products-list" class="">
                    @include("components.products-list", ["products" => $products])
                </div>
            </div>
            <aside
                class="top-28 mx-auto mt-10 max-h-[575px] w-full overflow-y-scroll rounded-xl bg-white shadow-2xl md:sticky md:float-end md:mt-0 md:max-w-[35%] xl:max-w-[30%] [&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-green-600 [&::-webkit-scrollbar-track]:bg-transparent"
            >
                <form class="rounded-xl" id="productForm">
                    <div class="flex justify-center pt-4">
                        <p
                            class="text-center font-mono text-xl font-semibold tracking-tight text-green-600 underline xl:text-2xl"
                        >
                            Masukkan Produk
                        </p>
                        <span class="text-xl xl:text-[26px]">😀</span>
                    </div>
                    <div class="space-y-3 p-5">
                        ...
                        <div class="flex flex-col gap-0.5">
                            ...
                            <input
                                ...
                                name="name"
                                type="text"
                                class="rounded-md border-2 border-gray-400 px-2 py-1 text-lg outline-gray-600"
                            />
                        </div>
                        <div class="flex flex-col gap-0.5">
                            <label for="">
                            ...
                            <textarea
                                ...
                                cols="30"
                                rows="5"
                                class="rounded-md border-2 border-gray-400 px-2 py-1 outline-gray-600"
                            ></textarea>
                        </div>
